...
*	You should call this if you application makes use of either device camera and might have the camera video settings enabled.
...
*	NB: This flag is cleared after each upload of data, so if you wish to mark a user as a favorite across multiple sesssions you will need to call this once in each session
*/
