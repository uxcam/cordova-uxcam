...
Version | Changes
--------|--------
3.2.1-beta.4	 | iOS SDK updated to v3.1.13
3.2.1-beta.3	 | iOS SDK updated to v3.1.12
3.2.1-beta.2	 | iOS SDK updated to v3.1.11 and Android SDK to 3.1.13-beta.5
